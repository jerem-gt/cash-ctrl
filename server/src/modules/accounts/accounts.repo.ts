...
export function createAccountsRepo(db: Database) {
    return {
        ...
        create(userId: number, data: CreateAccountInput) {
            ...
            ).run(userId, data.name, data.bank_id, data.account_type_id, data.initial_balance);
        },
        ...
        update(userId: number, id: number, data: UpdateAccountInput) {
            ...
            ).run(data.name, data.bank_id, data.account_type_id, data.initial_balance, id, userId);
        },
