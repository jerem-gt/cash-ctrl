...
export const ACCOUNT_TYPES: AccountType[] = [
  { id: 1, name: 'Courant', is_investment: 0, is_loan: 0, envelope_type: null, acc_count: 1 },
  { id: 3, name: 'Bourse', is_investment: 1, is_loan: 0, envelope_type: null, acc_count: 1 },
  {
    id: 4,
    name: 'Assurance Vie',
    is_investment: 0,
